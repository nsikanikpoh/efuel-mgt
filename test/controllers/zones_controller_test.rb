...
class ZonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post zones_url, params: { zone: { company: @zone.company, name: @zone.name, state: @zone.state } }
    end
  ...
  test "should update zone" do
    patch zone_url(@zone), params: { zone: { company: @zone.company, name: @zone.name, state: @zone.state } }
