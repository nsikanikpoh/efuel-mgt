...
class PumpsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pump" do
    assert_difference('Pump.count') do
      post pumps_url, params: { pump: { name: @pump.name, product_id: @pump.product_id, station_id: @pump.station_id } }
    end
  ...
  test "should update pump" do
    patch pump_url(@pump), params: { pump: { name: @pump.name, product_id: @pump.product_id, station_id: @pump.station_id } }
