...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { address: @station.address, city: @station.city, company_id: @station.company_id, name: @station.name, state: @station.state } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { address: @station.address, city: @station.city, company_id: @station.company_id, name: @station.name, state: @station.state } }
